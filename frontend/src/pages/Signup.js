...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDF9] flex items-center justify-center p-6">
      <Card className="w-full max-w-md p-8 border-[#E5E7E1] rounded-3xl" data-testid={AUTH.signupForm}>
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-[#666] mt-2">Start your health journey today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#1A1F16] mb-2">Confirm Password</label>
            <Input
              type="password"
        ...
        <p className="text-center text-sm text-[#666] mt-6">
          ...
          <Link
            to="/login"
            data-testid={AUTH.switchToLogin}
